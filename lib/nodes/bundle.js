...
registry.decl(BundleNodeName, BlockNode, /** @lends BundleNode.prototype */ {
    ...
    __constructor: function(o) {
        ...
        this.item = U.extend({}, this.item);
        delete this.item.suffix;
    },
    ...
    createChildNodes: function(parent) {
        ...
        this.getTechs().map(function(tech) {
            var techNode = this.createTechNode(tech, parent, this);
            if (techNode && ~optTechs.indexOf(tech)) {
                this.createOptimizerNode(tech, techNode, parent);
            }
        }, this);
    ...
    linkParent: function(parentId) {
        ...
        return !(parent instanceof MagicNode.MagicNode) &&
            (!(parent instanceof TargetNode.TargetNode) || ('=' + this.getId()) === parentId);
    },
...
registry.decl(MergedBundleNodeName, BundleNodeName, /** @lends MergedBundleNode.prototype */ {
     ...
     * in the form level.bundles:bundle
    ...
    getMergeBundles: function() {
        ...
        return this.ctx.arch.getChildren(id.substring(0, id.lastIndexOf(':')) + '+');
    },

    make: function() {
        var path = PATH.dirname(this.rootLevel.resolveBemPath(this.resolved));
