...
registry.decl(LevelNodeName, MagicNode, {
    ...
    __constructor: function(o) {
        ...
        var parentLevel = typeof o.level === 'string'?
                        createLevel(PATH.resolve(o.root, o.level)) :
                        o.level,
            level = createLevel(parentLevel.getPathByObj(o.item || o, o.item.tech));
        o.level = level;

        this.__base(U.extend({}, o, {level: level}));
    ...
    alterArch: function() {
        ...
        return function() {
            ...
            console.log('creating node %s', this.itemNodeClassName)
...
registry.decl(BundlesLevelNodeName, LevelNodeName, {
     ...
     */
    scanLevelItems: function() {
console.log('scan %s', this.level.dir)
        return _.uniq(
            _.sortBy(
                this.level.getItemsByIntrospection()
                    .filter(function(item) {
