var INHERIT = require('inherit'),
    ...
    MergedBundleNode = require('./mergedbundle'),
...
registry.decl(BundlesLevelNodeName, LevelNodeName, {
    ...
    itemNodeClassName: BundleNode.BundleNodeName,
    ...
    alterArch: function() {
        ...
        return function() {
            ...
            if (this.buildMergedBundle() && this.mergedBundleName() &&
                !arch.hasNode(MergedBundleNode.MergedBundleNode.createId({
                ...
                arch.setNode(new MergedBundleNode.MergedBundleNode({
                    root: this.root,
                    level: this.level,
                    item: {block: this.mergedBundleName()}}), arch.getNode(this.path).getId(), this);
            }
        }
    },
