...
Для того, чтобы проверить правильность внесённых изменений, рекомендуем выполнить следующую команду в корневой директории и убедиться в то, что все тесты выполнились без ошибок:
