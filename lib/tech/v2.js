...
var Q = require('q'),
    ...
    Tech = exports.Tech = INHERIT(/** @lends Tech.prototype */ {
        ...
        /**
         * Implementation of 'bem create' command.
         *
        ...
        getBuildResults: function(decl, levels, output, opts) {
            var _this = this,
                res = {},
                files = this.getBuildPaths(decl, levels, output, opts);
        ...
        getBuildPaths: function(decl, levels, output, opts) {
            var _this = this,
                res = {},
        ...
        getTechRelativePath: function(from) {
            ...
            if(!testDotRe.test(techPath) && testLibRe.test(techPath)) {
                techPath = techPath.replace(replaceRe, '');
            } else {
        ...
        /**
         * Stub. Return true to prefer the tech being executed in a separate process.
         *
         * @public
         * @return {Boolean}
         */
