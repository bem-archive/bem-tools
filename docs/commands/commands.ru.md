...
В команде `make` реализована сборка БЭМ-проектов. Узнать больше о системах сборки можно из доклада Сергея Белова [bem server: система сборки фронтенда](http://clubs.ya.ru/yasubbotnik/replies.xml?item_no=406).
