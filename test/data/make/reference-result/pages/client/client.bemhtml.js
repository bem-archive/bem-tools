var BEMHTML = (function(exports) {
    ...
    function $76() {
        var __r44, __r45, __r46, __r47;
        {
            var ctx = this.ctx, props = [ "title", "target" ], p = typeof ctx.url, a = {
                href: p === "undefined" || p === "string" ? ctx.url : (p = [], "", __r44 = this._buf, this._buf = p, __r45 = this._mode, this._mode = "", __r46 = this.ctx, this.ctx = ctx.url, __r47 = $152.call(this), this._buf = __r44, this._mode = __r45, this.ctx = __r46, "", __r47, p.join(""))
            };
            while (p = props.pop()) {
                ctx[p] && (a[p] = ctx[p]);
            }
    ...
    function $173() {
        var __r18, __r8, __r12, __r13, __r14, __r15, __r16, __r17, __r9, __r19, __r22, __r23, __r24, __r25, __r26, __r27;
        {
            ...
            tag = ("", __r8 = this._mode, this._mode = "tag", __r9 = $2.call(this), this._mode = __r8, "", __r9);
            typeof tag != "undefined" || (tag = v.tag);
            typeof tag != "undefined" || (tag = "div");
            if (tag) {
                var jsParams, js;
                if (this.block && v.js !== false) {
                    js = ("", __r12 = this._mode, this._mode = "js", __r13 = $98.call(this), this._mode = __r12, "", __r13);
                ...
                undefined;
                buf.push("<", tag);
                var isBEM = ("", __r14 = this._mode, this._mode = "bem", __r15 = $109.call(this), this._mode = __r14, "", __r15);
                ...
                undefined;
                var attrs = ("", __r24 = this._mode, this._mode = "attrs", __r25 = $64.call(this), this._mode = __r24, "", __r25);
            ...
            if (this._.isShortTag(tag)) {
                ...
                tag && buf.push(">");
                var content = ("", __r26 = this._mode, this._mode = "content", __r27 = $42.call(this), this._mode = __r26, "", __r27);
