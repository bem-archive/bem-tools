...
var Q = require('q'),
    ...
    EntityNodeName = require('./entity').EntityNodeName,
...
registry.decl(GeneratedFileNodeName, FileNodeName, /** @lends GeneratedFileNode.prototype */ {
    ...
    isValid: function() {
        ...
        var arch = this.ctx.arch,
            ...
            EntityNode = registry.getNodeClass(EntityNodeName),
            children = arch.getChildren(this)
                .filter(function(child) {
                    var node = arch.getNode(child);
                    return (child && (node instanceof exports.FileNode ||
