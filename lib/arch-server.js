...
exports.server = INHERIT(SERVER, {
    ...
    startServer: function(requestHandler) {
        ...
        started.push(netServer.listen(_this.opts.archport, _this.opts.host).then(function(listener) {

            LOGGER.finfo('Arch visualization server is listening on port %s. Point your browser to http://localhost:%s/',
                _this.opts.archport,
                _this.opts.archport);
