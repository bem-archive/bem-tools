var INHERIT = require('inherit'),
    ...
    LevelNode = require('./nodes/level'),
    BundlesLevelNode = require('./nodes/level'),
    LibraryNode = require('./nodes/lib'),
...
registry.decl('Arch', {
    ...
    createBlockLibrariesNodes: function(parent) {
        ...
        return Object.keys(libs).map(function(l) {
            ...
            var lib = libs[l],
                libNodeClass = U.toUpperCaseFirst(lib.type) + LibraryNode.LibraryNodeName,
    ...
    createBundlesLevelsNodes: function(parent, children) {
        return this.createLevelsNodes(
            ...
            BundlesLevelNode.BundlesLevelNode,
            parent,
            children
        );
    },
