                ...
                .spread(function(pkg, bower) {
                    ...
                    return QFS.isDirectory(PATH.join(process.cwd(), '.git'))
                        .then(function(isGit) {
                            ...
                            if (isGit) {
                                return doGit(newVer, pkg, bower, mergeBranch);
                            }
...
function doGit(ver, pkg, bower, mergeBranch) {
                        ...
                        return U.execFile(git, ['rev-parse', '--abbrev-ref', 'HEAD'], opts, true)
                            .then(function(branch) {
                                ...
                                if (branch === mergeBranch) {
                                    L.warn('Skipping merge of ' + mergeBranch + ' into itself');
                                    return;
                                }

                                L.info('Merging ' + branch + ' into ' + mergeBranch);
