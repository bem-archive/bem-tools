 ...
 * @param {class} options.object pass object the methods of which you want to trace
 ...
 * @param {array} [options.whiteList] in case object was specified only methods in the whiteList will be wrapped
 * @param {array} [options.blackList] in case object was specified the methods in blackList hash won't be wrapped
