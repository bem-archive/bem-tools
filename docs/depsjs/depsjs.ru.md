...
Зависимости описываются для всех [БЭМ-сущностей](https://ru.bem.info/methodology/key-concepts/#БЭМ-сущность), если они разнесены по файловой структуре проекта и не отражены в [декларации](https://ru.bem.info/methodology/declarations/).
