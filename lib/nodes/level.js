    ...
    alterArch: function() {
        ...
        return function() {
            ...
            return Q.when(base.call(this), function() {
                ...
                if (_this.buildMergedBundle() && _this.mergedBundleName() &&
                    !arch.hasNode(Bundle.MergedBundleNode.createId({

                        root: _this.root,
                        level: _this.level,
                        item: {block: _this.mergedBundleName()}}))) {
                    ...
                    arch.setNode(new Bundle.MergedBundleNode({
                        root: _this.root,
                        level: _this.level,
                        item: {block: _this.mergedBundleName()}}), arch.getNode(_this.path).getId(), bundles);
