var Q = require('q'),
    ...
    PATH = require('./path'),
    FS = require('fs'),
    require = requireWrapper(require);
...
exports.levelOptParse = function() {
    ...
    return this.opt()
        ...
        .val(function(l) {
            return typeof l == 'string'? require('./level', true).createLevel(l) : l;
        })
        .end();
};
...
function requireWrapper(wrappedRequire) {
   ...
   func.resolve = wrappedRequire.resolve;
   func.cache = wrappedRequire.cache;
