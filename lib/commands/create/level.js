    ...
    return this
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            return Q.reject(UTIL.format('Base level "%s" not found', rel));
                        }
                    }
                }
        ...
        .act(function(opts, args) {
            ...
            return Q.all(args.names.map(function(name) {
                ...
                if (!opts.force && U.isDirectory(dir)) {
                    console.error('Skip "%s": already exists "%s"', name, dir);
                ...
                if (opts.level) {
                    ...
                    content.push('exports.baseLevelPath = require.resolve(\'' +
                        (PATH.isAbsolute(resPath)? PATH.relative(bemDir, resPath) : resPath) + '\');');
                }
                ...
                return U.mkdirp(bemDir)
                    .then(function() {
                        return U.write(levelFile, content.join('\n'));
                    });
