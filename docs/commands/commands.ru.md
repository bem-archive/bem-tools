...
Для автоматического обновления страницы в браузере при изменении исходного кода добавьте в bemjson.js ссылку на клиентский модуль `/refresh/vogue-client.js`:
...
Стили CSS обновляются без перезагрузки страницы. При изменении других файлов страница будет перезагружаться полностью.
