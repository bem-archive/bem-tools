...
registry.decl(BemBuildNodeName, EntityNode, {
    ...
    __constructor: function(o) {
        ...
        this.tech = this.level.createTech(o.techName, o.techPath);
        this.techPath = this.tech.getTechPath();
        this.tech.setContext(new Context(this.level, { level: this.levels }));
    },
    ...
    make: function() {
        ...
        var opts = {
            outputLevel: this.level.dir,
            level: this.levelsPaths,
            declaration: this.rootLevel.resolveBemPath(U.deserializeBemPath(this.declPath))[0],
            tech: this.techPath,
    ...
    getMetaNode: function() {
        ...
        var node = this.metaNode || (this.metaNode = new exports.BemBuildMetaNode({
            root: this.root,
            level: this.level,
            item: U.extend({}, this.item, {tech: this.item.tech + '.meta.js'}),
...
LOGGER.fdebug('removing %s', path)
    ...
    getPaths: function() {
        return this.rootLevel.resolveBemPath(this.resolved, this.tech.getBuildSuffixes());
    },

    getRelPaths: function() {
        return this.rootLevel.resolveBemRelPath(this.resolved, this.tech.getBuildSuffixes());
    },
...
registry.decl(BemBuildMetaNodeName, BemBuildNodeName, {
    ...
    isValid: function() {
        ...
        var decl = U.readDecl(this.rootLevel.resolveBemPath(U.deserializeBemPath(this.declPath))[0]),
            tech = this.tech,
