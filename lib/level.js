...
exports.createLevel = function(path) {
    ...
    var level = new (getLevelClass(PATH.resolve(path, '.bem', 'level.js'), true))(path);
...
var Level = exports.Level = INHERIT(/** @lends Level.prototype */{
    ...
    scanFiles: function(force) {
        ...
        return this.filesPromise = bemUtil.fsWalkTreeCb(this.dir)
            .then(function(files) {
                console.log('level %s scanned %s files', _this.dir, files.length);
                _this.files = files;
            });
    },
