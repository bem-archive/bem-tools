# deps.js — технология для описания зависимостей по БЭМ
...
Cуществуют два способа формирования страницы:

* [Статический](#Статический-способ-формирования-страницы) — сборка статической страницы на основе описанной [декларации](https://github.com/bem/bem-method/blob/godfreyd-methodology-deps/method/build/build.ru.md#Определение-списка-БЭМ-сущностей-для-страницы).
* [Динамический](#Динамический-способ-формирования-страницы) — предварительная сборка статических файлов (CSS, JS, шаблоны), с последующим формированием в runtime динамического БЭМ-дерева, на которое накладываются шаблоны.
...
![Статический способ формирования страницы](static.png)

Полный код:
* [декларации](https://gist.github.com/godfreyd/d0067f4d6d0342b56bf47420e20a8b9c)
* [logo.bemhtml.js](https://gist.github.com/godfreyd/2bf2a6a6a2f493cac3c361ab026ac07c)
* [logo.deps.js](https://gist.github.com/godfreyd/f15ba7fa0b1742f2381a12e76474ece6)


Если мы в БЭМ-дереве указываем какой-то блок, то в процессе сборки все необходимые для блока технологии, например, CSS и JS, будут автоматически собраны в общие файлы со всех уровней переопределения.

## Динамический способ формирования страницы

При формировании динамической страницы на этапе сборки проекта БЭМ-дерево отсутствует, соответственно, для предварительной генерации страницы нужно описать все необходимые БЭМ-сущности.
...
Таким же образом описываются элементы и модификаторы блоков, если они разнесены на файловой системе и не отражены во входящем BEMJSON-файле.
...
Для того, чтобы в сборку клиентского JavaScript попали шаблоны блока `b1` с модификатром `_m1_v1`, зависимости в `deps.js`-сущности блока можно выразить следующим образом:
