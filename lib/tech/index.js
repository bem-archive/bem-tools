...
var TechV1 = exports.Tech = require('./v1').Tech,
    ...
    getTechClass = exports.getTechClass = function(module, level) {
        ...
        if (!tech.API_VER || tech.API_VER < 2) {
            console.warn('WARNING! Tech modules API V1 is not recommended to use, because it is slow. ' +
        ...
        // legacy tech module detected, should use LegacyTech shim
            ...
            console.warn('WARNING! Legacy tech modules API support is deprecated and will be removed ' +
                'in bem-tools@1.0.0, please use tech modules API V2');
