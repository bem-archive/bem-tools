...
registry.decl(BemBuildNodeName, GeneratedFileNode, {
                    ...
                    if (strategy === 'promised') {
                        ...
                        return (function() {
                            ...
                            return Q.all(meta.map(function(m) {
                                ...
                                return U.lastModified(PATH.resolve(_this.root, m))
                                    .then(function(d) {
                        ...
                        return (function() {
                            ...
                            meta.forEach(function(path) {
                                ...
                                FS.stat(PATH.resolve(_this.root, path), function(err, stat) {
                                    ...
                                    if (err || stat.mtime.getTime() > nodeLastModified) d.fulfill(false);
    ...
    make: function() {
        ...
        var _this = this,
            ...
            handler = function(m) {
                (m.code !== 0)? d.reject(m.msg) : d.fulfill();
            };
        ...
        var decl = U.readDecl(PATH.resolve(this.root, this.declPath)),
            ...
            filteredPaths = tech.filterPrefixes(prefixes, tech.getSuffixes())
                .then(function(prefixes) {
                    return prefixes.map(relativize);
                }),
