...
var BemBuildNode = exports.BemBuildNode = INHERIT(GeneratedFileNode, {
    ...
    isValid: function(ctx) {
        ...
        return Q.when(this.__base(ctx), function(valid){
            ...
            return Q.all([
                    QFS.read(PATH.resolve(ctx.root, meta.getPath())),
                    _this.lastModified(),
                    meta.lastModified()
                ])
...
var BemBuildMetaNode = exports.BemBuildMetaNode = INHERIT(BemBuildNode, {
    ...
    isValid: function(ctx) {
        ...
        var decl = require(PATH.resolve(ctx.root, this.declPath), true),
            ...
            savedPaths = QFS.read(PATH.resolve(ctx.root, this.getPath()))
                .then(function(c) {
                    // FIXME: read relative to .meta.js file paths
        ...
        // NOTE: expired if build is force; must return after filling the ctx with promises
        if ((ctx.method && ctx.method != 'make') || ctx.force) return false;
            ...
            .spread(function(allPaths, filteredPaths, savedPaths) {
                return arch.withLock(_this.alterArch(ctx, allPaths, filteredPaths, savedPaths), _this)
                    .then(function() {
                        ...
                        // FIXME: store relative to .meta.js file paths
