...
var BundleNode = exports.BundleNode = INHERIT(MagicNode, {
    ...
    alterArch: function(ctx) {
        ...
        return function() {
            ...
            this.getTechDeps().map(function(tech) {
                ...
                var optimizer = _this.createOptimizerNode(ctx, n, tech);
                if (optimizer) {
                    arch.replaceNode(optimizer);
                    arch.link(n.getId(), optimizer.getId());
                    arch.link(optimizer.getId(), bundleNode);
                }
            });
    ...
    'create-css-optimizer-node': function(ctx, sourceNode) {
        return new (registry.getNodeClass('BorschikNode'))(sourceNode, 'css', true);
    },
