var FS = require('fs'),
    ...
    Tech = exports.Tech = INHERIT({
        ...
        create: function(prefix, vars, force) {
            ...
            return Q.step(
                function() {
                    return _this.getCreateResults(prefix, vars);
                },
                function(res) {
                    return _this.storeCreateResults(prefix, res, force);
                }
            );
        },
        ...
        build: function(prefixes, outputDir, outputName) {
            ...
            return Q.step(
                function() {
                    return _this.getBuildResults(prefixes, outputDir, outputName);
                },
                function(res) {
                    return _this.storeBuildResults(PATH.join(outputDir, outputName), res);
                }
            );
        },
