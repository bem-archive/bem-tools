...
registry.decl(BundleNodeName, BlockNode, /** @lends BundleNode.prototype */ {
    ...
    alterArch: function() {
        ...
        return function() {
            ...
            this.getTechs().forEach(function(tech) {
                this.createTechNode(tech, bundleNode, this);
            }, this);
     ...
     * @return {Node}
     */
    setBemBuildNode: function(techName, declPath, bundleNode, magicNode, forked) {

        var arch = this.ctx.arch,
            tech = this.level.getTech(techName),
            buildNode = new BemBuildNode.BemBuildNode({
                ...
                forked: forked === undefined? ~this.getForkedTechs().indexOf(techName) || tech.preferFork(): forked
            });
     ...
     */
    setBemCreateNode: function(techName, bundleNode, magicNode, force, forked) {
...
registry.decl(MergedBundleNodeName, BundleNodeName, /** @lends MergedBundleNode.prototype */ {
     ...
     * @return {Node | undefined}
     */
    setBemDeclNode: function(techName, bundleNode, magicNode, cmd, decls, force) {
